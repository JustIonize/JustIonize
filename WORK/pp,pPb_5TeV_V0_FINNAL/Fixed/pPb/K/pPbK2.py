...
f = open("pPbK2FixedRESULTS.txt", "a")
...
Legend.AddEntry(Plot1,'2.0 < y < 2.5, T_{init}= 0.813 GeV', 'ep')
Legend.AddEntry(Plot2,'2.5 < y < 3.0, T_{init}= 0.809 GeV', 'ep')
Legend.AddEntry(Plot3,'3.0 < y < 3.5, T_{init}= 0.789 GeV', 'ep')
Legend.AddEntry(Plot4,'3.5 < y < 4.0, T_{init}= 0.716 GeV', 'ep')
