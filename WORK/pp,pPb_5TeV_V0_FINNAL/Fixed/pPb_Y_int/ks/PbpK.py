...
minuit1.DefineParameter(0, 'Area', 1000, 1e-1, 0., 0.)
minuit1.DefineParameter(1, 'Temper', 0.3, 1e-4, 0., 0.)
...
Legend.SetHeader('K_{s}^{0} Pb-p #sqrt{s_{NN}}= 5.02 TeV', 'C')
Legend.AddEntry(fFit1,'Tsallis, T_{init}= 0.759 GeV', 'l')
