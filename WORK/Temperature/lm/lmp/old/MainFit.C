...

{
    ...
    g1 = new TGraphErrors("lmbar_ppP.txt");
    g1->SetMarkerStyle(7);
    gPad->SetLogy(1);

    G1 = new TGraph("lmbar_ppP.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("lmbar_ppP.txt");
    g2->SetMarkerStyle(7);
    gPad->SetLogy(1);    

    G2 = new TGraph("lmbar_ppP.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("lmbar_ppP.txt");    
    g3->SetMarkerStyle(7);
    gPad->SetLogy(1);   

    G3 = new TGraph("lmbar_ppP.txt");
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("lmbar_ppP.txt"); 
