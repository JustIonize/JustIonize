...
nspd
'''
xLow01, xTop01, y01, Deltay01 = np.loadtxt('nvelo(325,350).txt', unpack=True)
xLow01Reper, xTop01Reper, y01Reper, Deltay01Reper = np.loadtxt('nvelo(325,350).txt', unpack=True)
