...

{
    ...
    G1->SetTitle("1203 nameless; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f = new TF1("f", "[1]*x*pow((x*x+0.497648*0.497648),0.5)*pow((1+([2]-1)*pow((x*x+0.497648*0.497648),0.5)*[0]),-([2]/([2]-1)))",0, 6);
    f->SetParameter(2, 1);
    f->SetParameter(1, 1000);
    f->SetParameter(0, 11.8);
