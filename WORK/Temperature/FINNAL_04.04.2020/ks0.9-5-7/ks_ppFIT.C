...
//________________________________________________________________
    ...
    latex.DrawLatex( 6, -0.1, "#sqrt{s_{NN}} (TeV)");

    TLatex latexY;
    latexY.SetTextSize(0.04);
    latexY.SetTextAlign(10);
    latexY.SetTextAngle(90);
    latexY.DrawLatex(-0.5,0.4,"T_{K_{s}^{0}} (GeV)");
    ...
    latexD.DrawLatex(3.2,0.44,"T_{K_{s}^{0}} vs #sqrt{s_{NN}}, p-p collisions");
