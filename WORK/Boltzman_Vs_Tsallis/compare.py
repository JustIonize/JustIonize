...
Tsallis = Area*pT*pow( (1 - (1-Q)*((m**2 + pT**2)**(0.5) - m)/Temper) , (1/(1-Q)) )
Boltzman = Area1*pT*np.exp(-np.sqrt(m**2 + pT**2)/Temper)
...
Legend.AddEntry(fFit1,'Tsallis, T_{init}= 0.803 GeV', 'l')
