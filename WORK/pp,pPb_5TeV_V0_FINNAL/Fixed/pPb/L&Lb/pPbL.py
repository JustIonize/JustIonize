...
minuit4.DefineParameter(0, 'Area', 300, 1e-1, 0., 0.)
minuit4.DefineParameter(1, 'Temper', 0.2, 1e-4, 0., 0.)
minuit4.DefineParameter(2, 'Q', 1.05, 1e-3, 0., 0.)
...
Plot1.SetTitle("#Lambda^{0} + #bar{#Lambda^{0}} pPb #sqrt{s_{NN}}= 5.02 TeV")
...
Legend.AddEntry(Plot1,'2.0 < y < 2.5, T_{init}= 1.035 GeV', 'ep')
Legend.AddEntry(Plot2,'2.5 < y < 3.0, T_{init}= 0.971 GeV', 'ep')
Legend.AddEntry(Plot3,'3.0 < y < 3.5, T_{init}= 0.930 GeV', 'ep')
Legend.AddEntry(Plot4,'3.5 < y < 4.0, T_{init}= 1.051 GeV', 'ep')
