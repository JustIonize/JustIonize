...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("NEWlmp.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("NEWlmp.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("NEWlmp.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("NEWlmp.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("NEWlmp.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("NEWlmp.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("NEWlmp.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("NEWlmp.txt");
    ...
    c1->cd(5);
    g5 = new TGraphErrors("NEWlmp.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("NEWlmp.txt");
    ...
    c1->cd(6);
    g6 = new TGraphErrors("NEWlmp.txt");
    g6->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G6 = new TGraph("NEWlmp.txt");
    ...
    latexD.DrawLatex(1.5,3,"#bar{#Lambda} LHCb p-Pb #sqrt{s_{NN}}= 5.02 TeV");
