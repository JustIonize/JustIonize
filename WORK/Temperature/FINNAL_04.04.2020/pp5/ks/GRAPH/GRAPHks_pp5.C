...
//________________________________________________________
    ...
    gPad->SetLogy(1);
    G2 = new TGraph("ks_pp5.txt");
    G2->SetTitle("1505; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f2 = new TF1("f2", "[2]*x*pow((1-(sqrt(pow(0.497648,2)+(x)^2)  - 0.497648 )*[0]*[1])  ,  (1/[1])  )",0, 6);
    f2 ->SetParameter(0,5.8);    
...
//__________________________________________________________
    ...
    gPad->SetLogy(1);
    g3->SetTitle("Andronic; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f3 = new TF1("f3", "[1]*x*pow((1+pow((x*[0]),2)),(-[2]))",0, 6);

    f3->SetParameter(2, 4);
    f3->SetParameter(1, 1000000);
    f3->SetParameter(0, 5);
...
//____________________________________________________________
    ...
    f6->SetParameter(2, -0.0736931);
    f6->SetParameter(1, 296.137);
    f6->SetParameter(0, 4.04043);
...
// FUNCTIONS :
    ...
    latexD.DrawLatex(1.5,12,"K_{s}^{0}, LHCb p-p #sqrt{s_{NN}}= 5.02 TeV");
