...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINks7.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINks7.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINks7.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("FINks7.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINks7.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINks7.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINks7.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINks7.txt");
    ...
    latexD.DrawLatex(3.3,0.2,"K_{s}^{0} ALICE p-p #sqrt{s_{NN}}= 7 TeV");
