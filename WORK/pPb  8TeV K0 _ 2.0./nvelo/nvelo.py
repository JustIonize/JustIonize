...
nvelo
'''
DATA = ['nvelo(25,50).txt','nvelo(175,200).txt','nvelo(325,350).txt']
...
Legend.AddEntry(Err1,'250 < nvelo < 500 ,\chi^{2}/NDF = 2.98/10 ,T_{init} = 0.607 GeV', ' lep ')
Legend.AddEntry(Err2,'1750 < nvelo < 2000 ,\chi^{2}/NDF = 1.90/12 ,T_{init} = 0.846 GeV', ' lep ')
Legend.AddEntry(Err3,'3250 < nvelo < 3500 ,\chi^{2}/NDF = 3.30/10,T_{init} = 0.861 GeV', ' lep ')
