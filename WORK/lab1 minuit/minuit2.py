...
def FCN(npar, gin, f , par , iflag ):
    ...
    indPos = yExpt>0
    arrayFCN = ((yExpt[indPos]**2) - yExpt[indPos]*yTheor[indPos])/yExpt[indPos] + yTheor[indPos]*np.log(1 + (yTheor[indPos] - yExpt[indPos])/yExpt[indPos])    
...
minuit.DefineParameter(2,'pos', 100., 1.e-4, 0.,0.)
