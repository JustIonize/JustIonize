...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINlp0.9.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINlp0.9.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINlp0.9.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("FINlp0.9.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINlp0.9.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINlp0.9.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINlp0.9.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINlp0.9.txt");
    ...
    c1->cd(5);
    g5 = new TGraphErrors("FINlp0.9.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("FINlp0.9.txt");
    ...
    c1->cd(6);
    g6 = new TGraphErrors("FINlp0.9.txt");
    g6->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G6 = new TGraph("FINlp0.9.txt");
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("FINlp0.9.txt"); 
   ...
   g->SetMarkerStyle(21);
    ...
    latexD.DrawLatex(0,0,"#bar{#Lambda} ALICE p-p #sqrt{s_{NN}}= 0.9 TeV");
