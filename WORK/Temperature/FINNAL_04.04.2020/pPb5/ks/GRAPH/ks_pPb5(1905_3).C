...
//    G1->SetTitle("1905_3; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f = new TF1("f", "[1]*x*pow((1-[2]*[0]*x),(1/[2]))",0, 6);
    f->SetParameter(2, -0.0736931);
    f->SetParameter(1, 296.137);
    f->SetParameter(0, 4.04043);
