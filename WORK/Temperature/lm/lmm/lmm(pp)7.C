...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINlm7.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINlm7.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINlm7.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("FINlm7.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINlm7.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINlm7.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINlm7.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINlm7.txt");
    ...
    c1->cd(5);
    g5 = new TGraphErrors("FINlm7.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("FINlm7.txt");
    ...
    c1->cd(6);
    g6 = new TGraphErrors("FINlm7.txt");
    g6->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G6 = new TGraph("FINlm7.txt");
    ...
    latexD.DrawLatex(0,0,"#Lambda LHCb p-p #sqrt{s_{NN}}= 7 TeV");
