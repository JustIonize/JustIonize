...
//____________________________________________________________
    ...
    c1->cd(1);
    g1 = new TGraphErrors("lm_pp5.txt");
    g1->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G1 = new TGraph("lm_pp5.txt");
...
//________________________________________________________
    ...
    c1->cd(2);
    g2 = new TGraphErrors("lm_pp5.txt");
    g2->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G2 = new TGraph("lm_pp5.txt");
...
//__________________________________________________________
    ...
    c1->cd(3);
    g3 = new TGraphErrors("lm_pp5.txt");
...
//-------------------------------------------------
    ...
    c1->cd(4);
    g4 = new TGraphErrors("lm_pp5.txt");
    g4->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G4 = new TGraph("lm_pp5.txt");
    G4->SetTitle("1203 nameless; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f4 = new TF1("f4", "[1]*x*pow((x*x+1.115683*1.115683),0.5)*pow((1+([2]-1)*pow((x*x+1.115683*1.115683),0.5)*[0]),-([2]/([2]-1)))",0, 6);
...
//_____________________________________________________________
    ...
    c1->cd(5);
    g5 = new TGraphErrors("lm_pp5.txt");
    g5->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G5 = new TGraph("lm_pp5.txt");
...
// FUNCTIONS :
    ...
    latexD.DrawLatex(1.5,17,"#Lambda, LHCb p-p #sqrt{s_{NN}}= 5.02 TeV");
