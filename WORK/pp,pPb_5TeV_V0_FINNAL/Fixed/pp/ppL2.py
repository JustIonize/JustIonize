...
Plot1.SetTitle("#Lambda^{0} pp #sqrt{s_{NN}}= 5.02 TeV")
...
Legend.AddEntry(Plot1,'2.0 < y < 2.5, T_{init}= 0.977 GeV', 'ep')
Legend.AddEntry(Plot2,'2.5 < y < 3.0, T_{init}= 0.821 GeV', 'ep')
Legend.AddEntry(Plot3,'3.0 < y < 3.5, T_{init}= 0.790 GeV', 'ep')
Legend.AddEntry(Plot4,'3.5 < y < 4.0, T_{init}= 0.756 GeV', 'ep')
