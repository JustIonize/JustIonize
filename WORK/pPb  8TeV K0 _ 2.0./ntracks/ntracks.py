...
Legend.AddEntry(Err1,'0 < ntracks < 100,\chi^{2}/NDF = 2.60/12 ,T_{init} = 0.707 GeV', ' lep ')
Legend.AddEntry(Err2,'100 < ntracks < 200 ,\chi^{2}/NDF = 1.37/12 ,T_{init} = 0.846 GeV', ' lep ')
Legend.AddEntry(Err3,'200 < ntracks < 300 ,\chi^{2}/NDF =  1.18/12,T_{init} = 0.863 GeV', ' lep ')
