...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINks0.9.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINks0.9.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINks0.9.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("FINks0.9.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINks0.9.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINks0.9.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINks0.9.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINks0.9.txt");
    G4->SetTitle("mod. Maxwell-Boltzman 3; pT GeV ; d(sigma)/d(pT) pb^(-1) "); 
    k = new TF1("k", "[2]*2*pi*x*pow((1-(sqrt(pow(0.497648,2)+(x)^2)  - 0.497648 )*[0]*[1])  ,  (1/[1])  )",0, 6);
    k ->SetParameter(1, -1);
    k ->SetParameter(0,4);
    k ->SetParameter(2,1);
    G4->Fit(k,"N");
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("FINks0.9.txt"); 
    ...
    legend->AddEntry("f","Maxwell-Boltzmann dist.","l");
    legend->AddEntry("h","Bolt. + Fermi-Dir. + Bose-Ein.","l");
    legend->AddEntry("j","Mod. Maxwell-Boltzmann dist.","l");
    legend->AddEntry("k","Mod. Tsallis form","l");
    legend->Draw();
    ...
    latexD.DrawLatex(1.7,0.016,"K_{s}^{0} ALICE p-p, INEL #sqrt{s_{NN}}= 0.9 TeV");
