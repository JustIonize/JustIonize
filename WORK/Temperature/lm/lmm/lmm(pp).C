...

{
    ...
    c1->cd(5);
    g5 = new TGraphErrors("lm_pp.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("lm_pp.txt");
    ...
    c1->cd(6);
    g6 = new TGraphErrors("lm_pp.txt");
    g6->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G6 = new TGraph("lm_pp.txt");
    ...
    latexD.DrawLatex(1.5,10,"#Lambda LHCb p-p #sqrt{s_{NN}}= 5.02 TeV");
