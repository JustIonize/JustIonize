...

{
    ...
    c1->cd(5);
    g5 = new TGraphErrors("FINks0.9.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("FINks0.9.txt");
