...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINlm2,76.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINlm2,76.txt");
    G1->SetTitle("Maxwell-Boltzman; pT GeV ; d(sigma)/d(pT) pb^(-1) ");
    f = new TF1("f", "[1]*((x)^2)*exp(-sqrt((x)^2 + pow(m,2))*[0])",0, 12);
    G1->Fit(f,"N");
    G1->Draw("APSAME");
    g1->Draw("P");
    f->SetLineWidth(5);
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINlm2,76.txt");    
    g2->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G2 = new TGraph("FINlm2,76.txt");
    G2->SetTitle("mod. Maxwell-Boltzman; pT GeV ; d(sigma)/d(pT) pb^(-1) ");      
    h = new TF1("h", "[1]*x*sqrt((x)^2+m^2)*exp(-sqrt((x)^2 + pow(m,2))*[0])",0, 12);
    G2->Fit(h,"N");
    G2->Draw("APSAME");
    g2->Draw("P");
    h->SetLineWidth(5);
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINlm2,76.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINlm2,76.txt");
    G3->SetTitle("mod. Maxwell-Boltzman 2; pT GeV ; d(sigma)/d(pT) pb^(-1) ");      
    j = new TF1("j", "[1]*x*exp(-sqrt((x)^2 + pow(m,2))*[0])",0, 12);
    G3->Fit(j,"N");
    G3->Draw("APSAME");
    g3->Draw("P");
    j->SetLineWidth(5);
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINlm2,76.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINlm2,76.txt");
    G4->SetTitle("mod. Maxwell-Boltzman 3; pT GeV ; d(sigma)/d(pT) pb^(-1) "); 
    k = new TF1("k", "[2]*2*pi*x*pow((1-(sqrt(pow(1.115683,2)+(x)^2)  - 1.115683 )*[0]/[1])  ,  ([1])  )",0, 12);
    k ->SetParameter(1,10);
    k ->SetParameter(2, 10);
        k ->SetParameter(0, 0.1);
    G4->Fit(k,"N");
    G4->Draw("APSAME");
    g4->Draw("P");
    k->SetLineWidth(5);
    ...
    c1->cd(5);
    g5 = new TGraphErrors("FINlm2,76.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("FINlm2,76.txt");
    G5->SetTitle("Maxwell-Boltzman+; pT GeV ; d(sigma)/d(pT) pb^(-1) ");
    t = new TF1("t", " [1]*x*pow((1+(x*[0])*(x*[0])),(-[2]))",0, 12);
    t->SetParameter(2, 1);
    t->SetParameter(1, 1);
    G5->Fit(t,"N");
    G5->Draw("APSAME");
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("FINlm2,76.txt"); 
    ...
    latexD.DrawLatex(0,0,"#Lambda LHCb Pb-Pb #sqrt{s_{NN}}= 2.76 TeV");
