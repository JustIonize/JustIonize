...

{
    ...
    c1->cd(1);
    g1 = new TGraphErrors("FINks2,76.txt");
    g1->SetMarkerStyle(21);
    gPad->SetLogy(1);
    G1 = new TGraph("FINks2,76.txt");
    ...
    c1->cd(2);
    g2 = new TGraphErrors("FINks2,76.txt");    
    g2->SetMarkerStyle(21);

    gPad->SetLogy(1);   
    G2 = new TGraph("FINks2,76.txt");
    ...
    c1->cd(3);
    g3 = new TGraphErrors("FINks2,76.txt");    
    g3->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G3 = new TGraph("FINks2,76.txt");
    ...
    c1->cd(4);
    g4 = new TGraphErrors("FINks2,76.txt");    
    g4->SetMarkerStyle(21);
    gPad->SetLogy(1);   
    G4 = new TGraph("FINks2,76.txt");
    G4->SetTitle("mod. Maxwell-Boltzman 3; pT GeV ; d(sigma)/d(pT) pb^(-1) "); 
    k = new TF1("k", "[2]*2*pi*x*pow((1-(sqrt(pow(0.497648,2)+(x)^2)  - 0.497648 )*[0]*[1])  ,  (1/[1])  )",0, 12);
    k ->SetParameter(1, -1);
    k ->SetParameter(0,8);
    k ->SetParameter(2,50);
    G4->Fit(k,"N");
    ...
    c1->cd(5);
    g5 = new TGraphErrors("FINks2,76.txt");
    g5->SetMarkerStyle(21);
    gPad->SetLogy(1);    
    G5 = new TGraph("FINks2,76.txt");
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("FINks2,76.txt"); 
    ...
    latexD.DrawLatex(1.7,0.016,"K_{s}^{0} ALICE Pb-Pb #sqrt{s_{NN}}= 2.76 TeV");
