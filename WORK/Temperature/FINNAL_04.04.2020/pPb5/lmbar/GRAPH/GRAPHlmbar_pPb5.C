...
//________________________________________________________
    ...
    c1->cd(2);
    g2 = new TGraphErrors("lmbar_pPb5.txt");
    g2->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G2 = new TGraph("lmbar_pPb5.txt");
...
//__________________________________________________________
    ...
    c1->cd(3);
    g3 = new TGraphErrors("lmbar_pPb5.txt");
    g3->SetMarkerStyle(21);

    gPad->SetLogy(1);
    //G3 = new TGraph("lmbar_pPb5.txt");
    //G3->SetTitle("1203 nameless; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f3 = new TF1("f3", "[1]*x*pow((x*x+1.115683*1.115683),0.5)*pow((1+([2]-1)*pow((x*x+1.115683*1.115683),0.5)*[0]),-([2]/([2]-1)))",0, 6);

    f3->SetParameter(2, 1.1);
...
//-------------------------------------------------
    ...
    c1->cd(4);
    g4 = new TGraphErrors("lmbar_pPb5.txt");
    g4->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G4 = new TGraph("lmbar_pPb5.txt");
    G4->SetTitle("1203_3; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f4 = new TF1("f4", "[1]*pow((1+([2]-1)*pow((x*x+1.115683*1.115683),0.5)*[0]),-(1/([2]-1)))",0, 6);
    f4->SetParameter(2, 1.15);
...
//_____________________________________________________________
    ...
    c1->cd(5);
    g5 = new TGraphErrors("lmbar_pPb5.txt");
    g5->SetMarkerStyle(21);

    gPad->SetLogy(1);
    G5 = new TGraph("lmbar_pPb5.txt");
    G5->SetTitle("1905_2; pT GeV ; d(sigma)/d(pT) mb*C/(GeV) ");

    
    f5 = new TF1("f5", "[1]*x*pow((1-[2]*[0]*(pow((x*x+1.115683*1.115683),0.5))),(1/[2]))",0, 6);
    f5->SetParameter(2, 0.001);
    f5->SetParameter(1, 1000000000);
    f5->SetParameter(0, 5.8);
...
//__________________________________________________________
    ...
    gPad->SetLogy(1);
    g = new TGraphErrors("lmbar_pPb5.txt"); 
...
// FUNCTIONS :
    ...
    legend->AddEntry("f3","F_{T7}","l");
    legend->AddEntry("f4","F_{T5}","l");
    ...
    latexD.DrawLatex(1.5,1,"#bar{#Lambda}, LHCb p-Pb #sqrt{s_{NN}}= 5.02 TeV");
