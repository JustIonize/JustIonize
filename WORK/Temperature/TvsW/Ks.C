...

{
    ...
    g3 = new TGraphErrors("0.9, 5, 7 (Ks)№3.txt");
    g3->SetName("g3");
    g3->SetMarkerStyle(21);
    g3->SetMarkerSize(2.0);
    g3->SetMarkerColor(2);
    g3->Draw("ACPSAME");
    g3->SetTitle("T(K_{s}^{0}), p-p #sqrt{s_{NN}}= 0.9, 5.02, 7 TeV;#sqrt{s_{NN}} (GeV) ;T (GeV)");

    g4 = new TGraphErrors("0.9, 5, 7 (Ks)№4.txt");
    g4->SetName("g4");
    ...
    g2 = new TGraphErrors("0.9, 5, 7 (Ks)№2.txt");
    g2->SetName("g2");
    ...
    g1 = new TGraphErrors("0.9, 5, 7 (Ks)№1.txt");
    g1->SetName("g1");
